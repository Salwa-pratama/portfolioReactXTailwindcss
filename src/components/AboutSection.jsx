        ...
        <div className="flex flex-wrap">
          <div className="w-full px-4 mb-10 lg:w-1/2">
            ...
            <p className="font-medium text-base text-secondary max-w-xl text-justify">
              ...
              commodi asperiores animi molestiae consectetur voluptas suscipit!
            </p>
          </div>
          <div className="w-full px-4 lg:w-1/2 lg:pl-[100px]">
            <h3 className="font-bold uppercase text-primary text-2xl mb-4 lg:text-3xl lg:pt-10 ">
              Let's Be Friends
            </h3>
            <p className="font-medium text-base text-secondary max-w-xl lg:text-lg text-justify">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Commodi
              culpa reprehenderit neque necessitatibus minus deleniti fuga?
            </p>
