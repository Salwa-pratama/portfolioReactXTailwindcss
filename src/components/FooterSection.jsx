...
export default function FooterSection() {
  ...
  return (
    <footer className="pt-24 pb-12 text-slate-400 dark:bg-black transition duration-300">
      <div className="flex flex-wrap">
        <div className="w-full px-4 mb-12 font-medium md:w-1/2">
          ...
          <span className="flex gap-2 items-center ">
            ...
            <a className="hover:text-blue-700 cursor-pointer">08986372441</a>
          </span>
          <h3 className="font-bold text-2xl my-2">Address</h3>
      ...
      <div className="flex gap-4 mt-4 pt-4 text-center items-center justify-center border-t-2">
        {/* Youtube Icon */}
        <a
          href=""
          target="_blank"
      ...
      <p className="mt-4 items-center justify-center text-center text-white sm:text-xl ">
        &copy; 2025 Ananda Salwa Pratama. Portfolio Website.
      </p>
