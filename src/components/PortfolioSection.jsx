...
export default function PortfolioSection() {
  return (
    <section
      id="portfolio"
      className="pt-36 pb-16  dark:bg-slate-800 transition duration-300"
    >
      <div className="w-full px-4">
        <div className="max-w-xl mx-auto text-center mb-16">
          <h4 className="font-semibold text-lg text-primary mb-2">Portfolio</h4>
          <h2 className="font-bold text-white text-3xl mb-4 sm:text-4xl lg:text-5xl dark:text-white transition duration-300">
            Projek Terbaru
          </h2>
